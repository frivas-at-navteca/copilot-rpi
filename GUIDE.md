...
The blueprint includes 29 operational rules learned from real sessions — including 6 Copilot-specific rules covering prompt file frontmatter, `${input:var}` syntax, instruction file globs, CLI auth, auto-compaction, and chatmode directories.
...
| Error patterns | `patterns/agent-errors.md` | 28 documented errors with symptoms and solutions |
| Operational rules | `patterns/quick-reference.md` | 29 rules to prevent known mistakes |
